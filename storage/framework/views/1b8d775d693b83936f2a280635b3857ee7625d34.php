        ...
        <div class="table-responsive table-responsive-data2">
          <table class="table table-data2">
            <thead>
              ...
              <tbody>
                <?php $__currentLoopData = $data_member; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    <td><?php echo e($member->name); ?></td>
                    <td><?php echo e($member->address); ?></td>
                    <td><?php echo e($member->phone); ?></td>
                    <td><?php echo e($member->email); ?></td>
                    <td><?php echo e($member->birth); ?></td>
                    <td><?php echo e($member->idNumber); ?></td>
                    <td>
                          <a href="/member/<?php echo e($member->id); ?>/edit" class="btn btn-warning" type="button">Edit</a>
                          <a href="/member/<?php echo e($member->id); ?>/delete" class="btn btn-danger" type="button" onclick="return confirm('Are you sure you want to permanently delete this member details?')">Delete</a>
                    </td>
                  </tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Pemrograman Web\web-perpus\resources\views/member/index.blade.php ENDPATH**/ ?>